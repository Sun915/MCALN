...
def train(epoch,imagetest):
    ...
    plt.savefig("/home/panpan/SunJia/GAN-VI-reid/Sun_code_dis1/log/hist_img/{}.jpg".format(epoch))
...
####################################################feature generater########################################
        ...
        #gan_loss_rgb1 = criterion_gan_mse(dis_rgb_feature1, ones)
        #gan_loss_ir1 = criterion_gan_mse(dis_ir_feature1, ones)
        ...
        loss = loss_id + loss_tri + loss_gan
        optimizer.zero_grad()
